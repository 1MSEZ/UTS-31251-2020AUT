...
public:
    ...
    T get_weight(const int&, const int&);   // returns the weight of an edge
...
template <typename T>
T directed_graph<T>::get_weight(const int& u_id, const int& v_id) {
    // assume there's an edge from u to v
